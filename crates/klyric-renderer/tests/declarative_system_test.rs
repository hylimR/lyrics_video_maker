use klyric_renderer::model::{Effect, EffectType, AnimatedValue, Transform, Easing, EffectTrigger};
...
fn test_expression_transform() {
    ...
    // y = t * 100
    properties.insert("y".to_string(), AnimatedValue::Expression("t * 100.0".to_string()));
...
fn test_typewriter_opacity() {
    ...
    let result = EffectEngine::compute_transform(0.05, &base, &effects_start, ctx_start);
