# Lyric Video Maker - Project Context

**Path:** `D:\Workspace\lyric_video_maker_claude`
...
```
D:\Workspace\lyric_video_maker_claude\
...
## 7. Current Focus
- Integrating the **Rust-based renderer** for video export.
- Finalizing **KLyric format** specifications (v2.0).
- Debugging **WASM** and native rendering parity.
