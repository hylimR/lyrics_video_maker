...
| Skill | Description |
|-------|-------------|
| [klyric-format](./klyric-format/SKILL.md) | KLyric v2.0 JSON format - document structure, styling, timing |
| [design-lyrics](./design-lyrics/SKILL.md) | **LLM-powered lyric video designer** - generates styled KLyric documents from mood/genre prompts |
| [rust-renderer](./rust-renderer/SKILL.md) | Dual-target Rust rendering engine (WASM/Native) |
| [tauri-commands](./tauri-commands/SKILL.md) | Tauri IPC commands - FFmpeg, video export |
| [zustand-cross-tab](./zustand-cross-tab/SKILL.md) | Cross-tab state sync with Zustand |
...
### Designing a Lyric Video Style
1. **design-lyrics** - Generate styled KLyric from mood/genre prompt
2. **klyric-format** - Understand document structure
3. **rust-renderer** - Implement custom effects if needed
