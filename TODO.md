...
## 🖥️ Desktop & UI
- [ ] **Packaging**: Finalize release configuration for production builds and installers.
- [ ] **Multi-Window Sync**: Further refine the sync logic for better performance in the full preview window.
